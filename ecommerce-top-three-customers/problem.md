...
- Write Mongo query to find the top 3 customers with the highest total order amount.

<h4 style="color:#397ce7">Sample Output:</h4>

```json
[
  { "_id": 2, "total_amount": 175, "customer_id": 2, "name": "Jane Doe" },
  { "_id": 1, "total_amount": 150.75, "customer_id": 1, "name": "John Smith" },
  { "_id": 4, "total_amount": 125.5, "customer_id": 4, "name": "Alice Lee" }
]
```
