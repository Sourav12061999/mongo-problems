...
- Write Mongo query to retrieve the documents from the `payments` collection where payment status is either `null` or `pending`.
- <span style="color:red">Hint:</span> use `$in`
