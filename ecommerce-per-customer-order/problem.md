...
- Write Mongo query to find the number of orders placed by each customer with name.

<h4 style="color:#397ce7">Sample Output:</h4>

```json
[
  { "_id": "Tom Wilson", "order_count": 2 },
  { "_id": "Bob Johnson", "order_count": 3 },
  { "_id": "Jane Doe", "order_count": 2 },
  { "_id": "John Smith", "order_count": 3 },
  { "_id": "Alice Lee", "order_count": 1 }
]
```
