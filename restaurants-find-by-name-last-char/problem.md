...
- Write a MongoDB query to find the `restaurant_id`, `name`, `borough` and `cuisine` for those restaurants which contain `ia` as last two letters for its name.
...
[
  ...
  {
    _id: ObjectId("64758d35308eef6bfe3c4f05"),
    borough: 'Manhattan',
    cuisine: 'American',
