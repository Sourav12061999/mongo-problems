...
- Write Mongo query to retrieve all the names of buyers who made at least one or more orders ?
- <span style="color:red">Hint:</span> use MongoDB query operator `$in`

- the output should look like this it will be array containing all buyers name.
...
## Given below e-commerce JSON data to perform Mongo queries.
