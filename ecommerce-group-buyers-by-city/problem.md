...
- Write Mongo query to group buyers by state and count the number of buyers in each state.
- Expected Output - it's one document from response to guess output should look like this for single document
