...
- Find all documents have air temperature less then 9 as key name "totalDocument" ?

- hint - use MongoDB aggregation pipeline with [$match](https://www.mongodb.com/docs/manual/reference/operator/aggregation/match/)  [$count](https://www.mongodb.com/docs/v6.0/reference/operator/aggregation/count/) 
