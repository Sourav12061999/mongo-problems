...
- Write Mongo Query to calculate the average score for each grade category (A, B, C, etc.) across all restaurants.

<h4 style="color:#397ce7">Sample Output:</h4>

```json
[
  { "_id": "B", "averageScore": 27 },
  { "_id": "A", "averageScore": 13 },
  { "_id": "Z", "averageScore": 38 },
  { "_id": "C", "averageScore": 60 },
  { "_id": "P", "averageScore": 12 }
]
```
