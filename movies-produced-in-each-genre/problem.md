...
- Problem - write query to Find the total number of movies produced in each `genre` ?
- hint - use aggregation to perform operations (group together with `_id = genre` and store count in `count`)
