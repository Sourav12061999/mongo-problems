...
- Write a MongoDB query to find the count of restaurants that have a `zipcode` ending with `14` and group them by `cuisine`.
...
```json
[
  { "_id": "American", "count": 3 },
  { "_id": "Delicatessen", "count": 1 },
  {
