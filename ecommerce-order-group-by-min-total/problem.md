...
- Write Mongo query to retrieve the orders grouped by customer_id with the min total.
- <span style="color:red">Hint:</span> use aggregation with `$group`

<h4 style="color:#397ce7">Sample Output:</h4>

```json
[
  { "_id": 3, "minTotal": 50.75 },
  { "_id": 4, "minTotal": 125.5 },
  { "_id": 1, "minTotal": 75 },
  { "_id": 5, "minTotal": 75.25 },
  { "_id": 2, "minTotal": 100 }
]
```
