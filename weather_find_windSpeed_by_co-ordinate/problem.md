...
- Find wind speed for co-ordinate [-76,26.4] as key name "windspeed"?

- hint - use MongoDB aggregation pipeline with [$match](https://www.mongodb.com/docs/manual/reference/operator/aggregation/match/)  [$project](https://www.mongodb.com/docs/v6.0/reference/operator/aggregation/project/) 
