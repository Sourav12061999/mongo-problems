...
- Write a MongoDB query to find the `restaurant_id`, `name`, `borough` and `cuisine` for those restaurants which belong to the borough `Staten Island`, `Queens`, `Bronx` and `Brooklyn`.
