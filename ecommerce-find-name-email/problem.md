...
- Write Mongo query to find the names and email addresses of all `buyers`.

<h4 style="color:#397ce7">Sample Output:</h4>

```json
[
  { "_id": 1, "name": "John Smith", "email": "john@hotmail.com" },
  { "_id": 2, "name": "Jane Doe", "email": "jane@example.com" },
  { "_id": 3, "name": "Bob Johnson", "email": "bob@example.com" },
  { "_id": 4, "name": "Alice Lee", "email": "alice@example.com" },
  { "_id": 5, "name": "Tom Wilson", "email": "tom@example.com" }
]
```
