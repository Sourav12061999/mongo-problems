...
- Write a MongoDB query to find the `borough` that have at least two restaurants with the same name.

<h4 style="color:#397ce7">Sample Output:</h4>

```json
[
  { "_id": "Manhattan", "restaurants": ["Domino'S Pizza"] },
  { "_id": "Bronx", "restaurants": ["Happy Garden"] }
]
```
