...
- Problem - write query to Find the total number of movies produced in each `year` ?
- hint - use aggregation to perform operations (group together with `_id = year` and store count in `count`)
