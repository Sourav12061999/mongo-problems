...
- Write Mongo query to calculate the total revenue generated by each shipper.

<h4 style="color:#397ce7">Sample Output:</h4>

```json
[
  { "revenue": 4899.95, "shipper_id": 1 },
  { "revenue": 9399.93, "shipper_id": 2 },
  { "revenue": 2899.98, "shipper_id": 3 }
]
```
