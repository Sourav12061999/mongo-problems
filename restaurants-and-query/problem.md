...
- Write a MongoDB query to find the restaurants that do not prepare any cuisine of `American` and their grade score more than `50` and `lattitude` less than `-65.754168`.
