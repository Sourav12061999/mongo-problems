...
- Write Mongo query to get the total number of suppliers in each city in `descending` order.
...
[
  { "_id": "Seoul", "count": 2 },
  { "_id": "Framingham", "count": 1 },
  { "_id": "Culver City", "count": 1 },
  { "_id": "Tokyo", "count": 1 },
  { "_id": "Cupertino", "count": 1 },
  { "_id": "Round Rock", "count": 1 }
]
```
