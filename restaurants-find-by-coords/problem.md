...
- Write a MongoDB query to find the `restaurant_id`, `name`, `address` and `geographical location` for those restaurants where 2nd element of coord array contains a value which is more than `10` and upto `41`.
