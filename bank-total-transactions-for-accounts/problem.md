...
- Find the total amount of money `transferred` in transactions for each account
  (group together with \_id=account_id) ?
- hint - use aggregation and store total amount in total_amount(key)
