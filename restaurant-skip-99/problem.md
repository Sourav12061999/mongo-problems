...
- Write a MongoDB query to Skip the first `99` restaurants in the `restaurants` collection and return the remaining ones.
...
[
  {
    _id: ObjectId("64758d35308eef6bfe3c4f29"),
    address: {
      building: '7201',
